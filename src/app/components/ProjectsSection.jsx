...
export default function ProjectsPage() {
  const projects = [
    ...
    description: "Kullanıcıların kredi veya banka kartı bilgilerini gerçek zamanlı olarak görselleştirmelerine olanak sağlayan interaktif bir kart uygulamasıdır. Kullanıcı kart numarasını girdikçe, kart üzerindeki bilgiler anında güncellenir ve kartın Visa mı yoksa MasterCard mı olduğu otomatik olarak tespit edilir. Kullanıcı dostu arayüzü sayesinde, kart bilgilerini yazarken aynı anda kartın ön yüzünde nasıl görüneceğini kolayca görebilirsiniz. Bu uygulama, hem görsel hem de fonksiyonel açıdan kart bilgilerini kontrol etmek isteyenler için pratik ve eğlenceli bir deneyim sunar.",
  ...
  return (
    <section id="projects" className="scroll-mt-24 pt-20">
      <a href="#projects" className="hover:underline text-4xl font-medium flex justify-center mb-4">Projelerim</a>
